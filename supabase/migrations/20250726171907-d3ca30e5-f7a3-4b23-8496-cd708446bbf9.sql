-- Create task templates for each shipping route
INSERT INTO public.task_templates (name, description, type, is_active) VALUES
('GRIMALDI Valencia', 'Shipping route from Valencia via GRIMALDI', 'shipping', true),
('GRIMALDI Monfalcone', 'Shipping route from Monfalcone via GRIMALDI', 'shipping', true),
('GRIMALDI Southampton', 'Shipping route from Southampton via GRIMALDI', 'shipping', true),
('GRIMALDI Antwerp', 'Shipping route from Antwerp via GRIMALDI', 'shipping', true),
('ORIENT Hamburg', 'Shipping route from Hamburg via ORIENT', 'shipping', true),
('ORIENT Antwerp', 'Shipping route from Antwerp via ORIENT', 'shipping', true),
('ORIENT Bremerhaven-Alexandria', 'Shipping route from Bremerhaven to Alexandria via ORIENT', 'shipping', true),
('MERNA Alicante', 'Shipping route from Alicante via MERNA', 'shipping', true),
('MERNA Marseille-Alexandria', 'Shipping route from Marseille to Alexandria via MERNA', 'shipping', true),
('DFDS Trieste', 'Shipping route from Trieste via DFDS', 'shipping', true),
('GLOVIS Antwerp-Kuwait', 'Shipping route from Antwerp to Kuwait via GLOVIS', 'shipping', true);
...
BEGIN
    ...
    VALUES (template_id, 'timestamp', 'Timestamp', 'datetime', true, field_order_counter);
